...
EMwwdQ <- function(z, zmarg, p, betal, tl, wwl, sigma) {
    .Call(`_LRMoE_EMwwdQ`, z, zmarg, p, betal, tl, wwl, sigma)
}

EMwwdQ2 <- function(zmarg, p, betal, tl, sigma) {
    .Call(`_LRMoE_EMwwdQ2`, zmarg, p, betal, tl, sigma)
}
