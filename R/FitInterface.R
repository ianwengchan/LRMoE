...
#'
#' @export
FitMLRMoE = function(Y, X, t, alpha_init, beta_init, ww_mu_init, ww_Sigma_init, n.sims = 10,
                     comp_dist, params_list, experts_init = NULL,
                     exposure = NULL,
                     exact_Y = FALSE,
                     penalty = TRUE, pen_alpha = 5.0, pen_params = NULL,
                     eps = 1e-3,
                     alphabeta_iter_max = 3, ww_iter_max = 5,
                     ecm_iter_max = 200,
                     grad_jump = TRUE, grad_seq = NULL,
                     print_steps = TRUE)
{
  ...
  if(exact_Y == TRUE){
    result = FitExactRandom(Y = Y, X = X, alpha.init = alpha_init, t = t, beta.init = beta_init,
                            ww.mu.list = ww_mu_init, ww.Sigma.list = ww_Sigma_init,
                            model = model_guess, n.sims = n.sims,
                            exposure = exposure,
                            penalty = penalty, pen_alpha = pen_alpha,
                            pen_params = pen_params,
                            eps = eps,
                            alphabeta_iter_max = alphabeta_iter_max, ww_iter_max = ww_iter_max,
